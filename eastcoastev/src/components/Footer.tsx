...
import { LOCATIONS, PRIMARY, EMAIL, EMAIL_HREF, cityList, shortAddress } from '../lib/locations';
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-contact">
              {LOCATIONS.map(loc => (
                <div className="footer-contact-item" key={loc.slug}>
        ...
        <div className="footer-bottom">
          <div className="footer-copy">
            ...
            <span style={{ color: 'var(--text-dim)' }}>· {cityList()}</span>
          </div>
